...
#
# Script generated by Vivado on Tue Feb 03 04:27:44 -0600 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xfft_128.sh
...
#
# Usage        : xfft_128.sh
#                xfft_128.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xfft_128.sh [-rerun]
#                xfft_128.sh [-reset_run]
#                xfft_128.sh [-clean]
#                xfft_128.sh [-reset_log]
#                xfft_128.sh [-help]
#
...
# script info
echo -e "xfft_128.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xfft_128.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xfft_128.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xfft_128.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xfft_128.sh [-help]\n\
Usage: xfft_128.sh [-step]\n\
Usage: xfft_128.sh [-lib_map_path]\n\
Usage: xfft_128.sh [-rerun]\n\
Usage: xfft_128.sh [-reset_run]\n\
Usage: xfft_128.sh [-clean]\n\
Usage: xfft_128.sh [-reset_log]\n\
Usage: xfft_128.sh [-keep_index]\n\
Usage: xfft_128.sh [-noclean_files]\n\n\

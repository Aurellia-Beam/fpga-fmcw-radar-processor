...
#
# Script generated by Vivado on Sun Feb 01 23:47:02 -0600 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xfft_doppler.sh
...
#
# Usage        : xfft_doppler.sh
#                xfft_doppler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xfft_doppler.sh [-rerun]
#                xfft_doppler.sh [-reset_run]
#                xfft_doppler.sh [-clean]
#                xfft_doppler.sh [-reset_log]
#                xfft_doppler.sh [-help]
#
...
# script info
echo -e "xfft_doppler.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xfft_doppler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xfft_doppler.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xfft_doppler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xfft_doppler.sh [-help]\n\
Usage: xfft_doppler.sh [-step]\n\
Usage: xfft_doppler.sh [-lib_map_path]\n\
Usage: xfft_doppler.sh [-rerun]\n\
Usage: xfft_doppler.sh [-reset_run]\n\
Usage: xfft_doppler.sh [-clean]\n\
Usage: xfft_doppler.sh [-reset_log]\n\
Usage: xfft_doppler.sh [-keep_index]\n\
Usage: xfft_doppler.sh [-noclean_files]\n\n\

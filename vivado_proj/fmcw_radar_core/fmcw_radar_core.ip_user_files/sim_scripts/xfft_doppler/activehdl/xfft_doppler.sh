...
#                script (type 'xfft_doppler.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Aurellia/Documents/GitHub/fpga-fmcw-radar-processor/vivado_proj/fmcw_radar_core/fmcw_radar_core.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then

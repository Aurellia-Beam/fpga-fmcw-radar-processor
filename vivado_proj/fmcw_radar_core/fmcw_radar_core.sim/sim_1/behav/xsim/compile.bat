...
REM
REM Generated by Vivado on Tue Feb 03 04:50:57 -0600 2026
...
echo "xvhdl --incr --relax -prj ADR_tb_quick_vhdl.prj"
call xvhdl  --incr --relax -prj ADR_tb_quick_vhdl.prj -log xvhdl.log

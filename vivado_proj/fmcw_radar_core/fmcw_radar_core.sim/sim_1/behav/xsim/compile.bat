...
REM
REM Generated by Vivado on Sat Jan 31 22:51:45 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_radar_core_vhdl.prj"
call xvhdl  --incr --relax -prj tb_radar_core_vhdl.prj -log xvhdl.log

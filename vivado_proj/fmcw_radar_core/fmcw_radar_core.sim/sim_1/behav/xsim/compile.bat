...
REM
REM Generated by Vivado on Fri Feb 06 04:22:44 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_tactical_vhdl.prj"
call xvhdl  --incr --relax -prj tb_tactical_vhdl.prj -log xvhdl.log

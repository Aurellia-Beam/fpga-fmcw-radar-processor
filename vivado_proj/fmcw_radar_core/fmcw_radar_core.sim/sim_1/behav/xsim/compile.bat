...
REM
REM Generated by Vivado on Mon Feb 02 00:03:25 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_magnitude_calc_vhdl.prj"
call xvhdl  --incr --relax -prj tb_magnitude_calc_vhdl.prj -log xvhdl.log

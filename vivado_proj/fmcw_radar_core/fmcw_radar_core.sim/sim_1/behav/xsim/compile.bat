...
REM
REM Generated by Vivado on Tue Feb 03 00:14:47 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_full_suite_vhdl.prj"
call xvhdl  --incr --relax -prj tb_full_suite_vhdl.prj -log xvhdl.log

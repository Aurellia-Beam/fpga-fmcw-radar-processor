...
REM
REM Generated by Vivado on Sun Feb 01 05:05:18 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_corner_turner_vhdl.prj"
call xvhdl  --incr --relax -prj tb_corner_turner_vhdl.prj -log xvhdl.log

...
namespace eval ::optrace {
  variable script "C:/Users/Aurellia/Documents/GitHub/fpga-fmcw-radar-processor/vivado_proj/fmcw_radar_core/fmcw_radar_core.runs/xfft_doppler_synth_1/xfft_doppler.tcl"
...
OPTRACE "xfft_doppler_synth_1" START { ROLLUP_AUTO }
...
set cacheID [config_ip_cache -export -no_bom  -dir C:/Users/Aurellia/Documents/GitHub/fpga-fmcw-radar-processor/vivado_proj/fmcw_radar_core/fmcw_radar_core.runs/xfft_doppler_synth_1 -new_name xfft_doppler -ip [get_ips xfft_doppler]]
...
synth_design -top xfft_doppler -part xc7a35ticsg324-1L -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix xfft_doppler_ xfft_doppler.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ xfft_doppler_stub.v
 lappend ipCachedFiles xfft_doppler_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ xfft_doppler_stub.vhdl
 lappend ipCachedFiles xfft_doppler_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ xfft_doppler_sim_netlist.v
 lappend ipCachedFiles xfft_doppler_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ xfft_doppler_sim_netlist.vhdl
 lappend ipCachedFiles xfft_doppler_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp xfft_doppler.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips xfft_doppler]
 }
...
rename_ref -prefix_all xfft_doppler_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef xfft_doppler.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file xfft_doppler_utilization_synth.rpt -pb xfft_doppler_utilization_synth.pb"  } 
...
OPTRACE "xfft_doppler_synth_1" END { }

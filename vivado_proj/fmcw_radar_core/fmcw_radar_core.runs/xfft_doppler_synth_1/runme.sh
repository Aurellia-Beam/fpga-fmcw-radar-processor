...
HD_PWD='C:/Users/Aurellia/Documents/GitHub/fpga-fmcw-radar-processor/vivado_proj/fmcw_radar_core/fmcw_radar_core.runs/xfft_doppler_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_doppler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_doppler.tcl
